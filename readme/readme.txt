...
Access fix command via menu: Options > Settings-plugins > Ruff > Fix current file
Access format command via menu: Options > Settings-plugins > Ruff > Format current file
