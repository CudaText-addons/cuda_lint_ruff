...
class Ruff(Linter):
    ...
    def _find_executable(self):
        ...
        try:
            ...
            bundled = os.path.join(base, 'Ruff', exe)
    ...
    def _parse_and_validate_config(self, content):
        ...
        try:
            ...
            return {'ignore': valid_ignore, 'select': valid_select}
...
class Command:
    ...
    def fix_file(self):
        ...
        try:
            ...
            msg_box("Ruff --fix timed out (>30s)", MB_OK | MB_ICONERROR)
        except Exception as e:
    ...
    def help(self):
        ...
        msg_box(
            ...
            '- Select: ["E", "W", "F", "B"]\n\n'
            "INSTALLATION:\n"
            "- Windows: Download ruff.exe from releases\n"
